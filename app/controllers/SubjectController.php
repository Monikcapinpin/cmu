...
class SubjectController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				subject.id LIKE ? OR 
				subject.code LIKE ? OR 
				subject.name LIKE ? OR 
				subject.Schedule LIKE ? OR 
				subject.Description LIKE ?
			)";
			$search_params = array(
		...
		$page_title = $this->view->page_title = "Subject";
	...
	function view($rec_id = null, $value = null){
		...
		if($record){
			$page_title = $this->view->page_title = "View  Subject";
		$this->view->report_filename = date('Y-m-d') . '-' . $page_title;
		$this->view->report_title = $page_title;
		$this->view->report_layout = "report_layout.php";
		$this->view->report_paper_size = "A4";
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("code","name","Schedule","Description");
		...
		$page_title = $this->view->page_title = "Add New Subject";
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","code","name","Schedule","Description");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'code' => 'required',
		...
		$page_title = $this->view->page_title = "Edit  Subject";
		if(!$data){
			$this->set_page_error();
		}
