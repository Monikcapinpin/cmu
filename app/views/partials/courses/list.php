        ...
        <div class="container-fluid">
            <div class="row ">
                ...
                <div class="col-sm-3 ">
                    ...
                    <a href="<?php print_link("courses/add") ?>"  class="btn btn btn-primary my-1 open-page-modal">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('courses'); ?>">
                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <?php } ?>
                                                <th class="td-sno">#</th>
                                                <th  class="td-Course"> Course(s)</th>
                                                <th  class="td-Abbreviation"> Abbreviation</th>
                                                <th  class="td-Discription"> Discription</th>
