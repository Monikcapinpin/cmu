            ...
            <div class="row justify-content-center">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="student_info-userregister-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("index/register?csrf_token=$csrf_token") ?>" method="post">
                            <!--[main-form-start]-->
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="Barcode">Barcode <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-Barcode"  value="<?php  echo $this->set_field_value('Barcode',random_chars(30)); ?>" type="text" placeholder="Enter Barcode"  readonly required="" name="Barcode"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
