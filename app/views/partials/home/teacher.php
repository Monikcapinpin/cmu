    ...
    <div  class="">
        <div class="container">
            <div class="row ">
                ...
                <div class="col-sm-4 comp-grid">
                    <?php $rec_count = $comp_model->getcount_studentinformation();  ?>
                    <a class="animated zoomIn record-count card bg-warning text-white"  href="<?php print_link("student_info/") ?>">
                        <div class="row">
                            <div class="col-2">
                            ...
                            <div class="col-10">
                                <div class="flex-column justify-content align-center">
                                    ...
                                    <small class="small desc">Display list of Student Information</small>
                                </div>
                            </div>
                            <h4 class="value"><strong><?php echo $rec_count; ?></strong></h4>
                        </div>
