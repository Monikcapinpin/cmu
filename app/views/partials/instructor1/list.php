    ...
    <div  class="bg-light p-3 mb-3 bg-transparent">
        <div class="container-fluid">
            <div class="row ">
                ...
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('instructor1'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('instructor1'); ?>">
                ...
                <div class="row justify-content-center">
                    <div class="col-sm-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="instructor1-list-records">
