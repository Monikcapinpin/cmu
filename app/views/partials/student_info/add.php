...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3 bgv">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Add New Student Info</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="student_info-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="<?php print_link("student_info/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <label class="control-label" for="Inst_id">Student ID <span class="text-danger">*</span></label>
                                    <div id="ctrl-Inst_id-holder" class=""> 
                                        <input id="ctrl-Inst_id"  value="<?php  echo $this->set_field_value('Inst_id',""); ?>" type="number" placeholder="Enter Student ID" step="1"  required="" name="Inst_id"  data-url="api/json/student_info_Inst_id_value_exist/" data-loading-msg="Checking availability ..." data-available-msg="Available" data-unavailable-msg="Not available" class="form-control  ctrl-check-duplicate" />
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-sm-4">
                                                            ...
                                                            <div id="ctrl-Block-holder" class=""> 
                                                                <select required=""  id="ctrl-Block" name="Block"  placeholder="Select a value ..."    class="custom-select" >
                                                                    <option value="">Select a value ...</option>
                                                                    <?php
                                                                    $Block_options = Menu :: $Block;
                                                                    if(!empty($Block_options)){
                                                                    foreach($Block_options as $option){
                                                                    $value = $option['value'];
                                                                    $label = $option['label'];
                                                                    $selected = $this->set_field_selected('Block', $value, "");
                                                                    ?>
                                                        ...
                                                        <div class="form-group col-sm-4">
                                                            <label class="control-label" for="Year">Year Level <span class="text-danger">*</span></label>
                                                            <div id="ctrl-Year-holder" class=""> 
                                                                <select required=""  id="ctrl-Year" name="Year"  placeholder="Select a value ..."    class="custom-select" >
                                                                    <option value="">Select a value ...</option>
                                                                    <?php
                                                                    $Year_options = Menu :: $Year;
                                                                    if(!empty($Year_options)){
                                                                    foreach($Year_options as $option){
                                                                    $value = $option['value'];
                                                                    $label = $option['label'];
                                                                    $selected = $this->set_field_selected('Year', $value, "");
                                                                    ?>
                                                                    <option <?php echo $selected ?> value="<?php echo $value ?>">
                                                                        <?php echo $label ?>
                                                                    </option>                                   
                                                        ...
                                                        <div class="form-group col-sm-4">
                                                            ...
                                                            <div id="ctrl-Program-holder" class=""> 
                                                                <select required=""  id="ctrl-Program" name="Program"  placeholder="Select a value ..."    class="custom-select" >
                                                                    <option value="">Select a value ...</option>
                                                                    <?php 
                                                                    $Program_options = $comp_model -> student_info_Program_option_list();
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="form-group ">
                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                <div class="form-group ">
                                                                    ...
                                                                    <div id="ctrl-Roles-holder" class=""> 
                                                                        <select required=""  id="ctrl-Roles" name="Roles"  placeholder="Select a value ..."    class="custom-select" >
                                                                            ...
                                                                            $value = $option['value'];
                                                                            $label = $option['label'];
                                                                            $selected = $this->set_field_selected('Roles', $value, "Student");
                                                                            ?>
                                                                            <option <?php echo $selected ?> value="<?php echo $value ?>">
                                                                                <?php echo $label ?>
                                                                            </option>                                   
                                                                ...
                                                                <input id="ctrl-Barcode"  value="<?php  echo $this->set_field_value('Barcode',random_chars(30)); ?>" type="hidden" placeholder="Enter Barcode"  readonly required="" name="Barcode"  class="form-control " />
