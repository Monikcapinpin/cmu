            ...
            <div class="row justify-content-center">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="student_info-teacheradd-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="<?php print_link("student_info/teacheradd?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <div class="row">
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="form-group ">
                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                <div class="form-group ">
                                                                    <label class="control-label" for="Inst_id">Inst Id <span class="text-danger">*</span></label>
                                                                    <div id="ctrl-Inst_id-holder" class=""> 
                                                                        <input id="ctrl-Inst_id"  value="<?php  echo $this->set_field_value('Inst_id',""); ?>" type="text" placeholder="Enter Inst Id"  required="" name="Inst_id"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
